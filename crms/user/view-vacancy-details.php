...
<?php } else if($cdate<$aadate) {?>
  <tr>
<th colspan="2" style="text-align:center; font-weight:bold; color:red; font-size:22px;">Job not open yet.</th>
  </tr>
<?php } else { ?>
  <th colspan="2" style="text-align:center; font-weight:bold; color:red; font-size:22px;">Job Expired</th>
<?php } ?>
  </form>
  </table>
                        </div>
