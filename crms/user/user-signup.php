...
$msg="This email or Contact Number already associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbluser(FullName,Email,MobileNumber,StudentID,Gender,semister,course,Password) value('$fullname','$email','$mobno','$stuid','$gender','$semister','$course','$password')");
    if ($query) {
...
<main>
    <div id="primary" class="blue4 p-t-b-100 height-full responsive-phone">
    	<h1 style="text-align: center;color:white;font-weight: bolder;font-size: 50px;">CANDIDATE REGISTRATION</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="assets/img/icon/asdf.jpg" alt="" style="margin-top: 5px;margin-left: -10px;">
                </div>
...
<input type="email" class="form-control form-control-lg no-b" name="email" id="email" placeholder="Enter your email" required="true">
              ...
              <input type="radio" name="gender" id="gender" value="Male"><strong style="color: white">Male</strong>
                                ...
                                <div class="col-lg-12">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="number" name="semister" required="true" placeholder="Enter Your semister" maxlength="8" pattern="[0-9]+" class="form-control form-control-lg no-b">
                                </div>
                                <div class="col-lg-12"  style="margin-left: -13.5px;">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="text" name="course" required="true" placeholder="Enter Your course" maxlength="120" class="form-control form-control-lg no-b" style="width: 540px;">
                                </div>

                            <div class="col-lg-12" style="margin-left: -13.5px;">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="password" name="password" required="true" class="form-control form-control-lg no-b"
                                           placeholder="Password" style="width: 540px;">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-left: -13.5px;">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="password" name="repeatpassword" required="true" class="form-control form-control-lg no-b"
                                           placeholder="Repeat Password" style="width: 540px;">
                                </div>
                            </div>
                           
                            <div class="col-lg-12" style="margin-left: 15px;">
                                <input type="submit" class="btn btn-primary btn-lg btn-block" name="submit" value="Sign Up">
